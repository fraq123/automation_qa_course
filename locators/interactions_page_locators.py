...
class SelectablePageLocators:
    ...
    LIST_ITEM_ACTIVE = (By.CSS_SELECTOR, 'ul[id="verticalListContainer"] li[class="mt-2 list-group-item active '
                                         'list-group-item-action"]')
    TAB_GRID = (By.CSS_SELECTOR, 'a[id="demo-tab-grid"]')
    LIST_GRID = (By.CSS_SELECTOR, 'li[class="list-group-item list-group-item-action"]')
    LIST_GRID_ACTIVE = (By.CSS_SELECTOR, 'li[class="list-group-item active list-group-item-action"]')
