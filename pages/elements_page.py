...
class CheckBoxPage(BasePage):
    ...
    def get_checked_checkboxes(self):
        ...
        for box in checked_list:
            title_item = box.find_element("xpath", self.locators.TITLE_ITEMS)
...
class LinksPage(BasePage):
    ...
    def check_broken_link(self, url):
        ...
        if request.status_code == 200:
            self.element_is_present(self.locators.BAD_REQUESTS).click()
        else:
    ...
    @allure.step('check no_content link')
...
class TestUploadAndDownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = rf'C:\Users\244eg\PycharmProjects\automation_qa_course\filetest{random.randint(0, 999)}.jpg'
